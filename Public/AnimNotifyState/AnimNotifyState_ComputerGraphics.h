...
protected:
	APlayerController* GetPlayerController(ACharacter* InCharacter) const;
	bool IsLocallyInputControlled(ACharacter* InCharacter) const;

public:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ComputerGraphics")
	ESimpleDrawComputerGraphicsType ComputerGraphicsType;
	
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ComputerGraphics")
	ESimpleDrawCGMixingEffectType CGMixingEffectType;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ComputerGraphics")
	FRotator CharacterRotatorOffset;
...
protected:
	UPROPERTY()
	TWeakObjectPtr<AActor> ViewObject;
};
